...
//
        ...
        DiagnosisTrigger: function(event,context){
                ...
                console.log("Entering Diagnosis Trigger Facebook");
                ...
                console.log("Exiting Diagnosis Trigger Facebook");
          },//END AGE AND GENDER INPUT function

          SaySymptomTrigger: function(event,context){
            console.log("Entering saySymptom Trigger Facebook");
...
//===============================================================================
        ...
        function processSymptom(event,context){
                console.log("Entering Process POST Facebook");
                ...
                console.log("Exiting POST Trigger Facebook");
          }//END AGE AND GENDER INPUT function
